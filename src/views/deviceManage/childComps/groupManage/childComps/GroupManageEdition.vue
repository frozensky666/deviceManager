            ...
            <div class="form">
                ...
                <div class="form-item">
                    ...
                    <el-select class="item-width" v-model="groupVO.parentId" placeholder="请选择">
                        <el-option v-for="item in groups" v-if="item.groupId!==groupId" :key="item.groupId" :value="item.groupId" :label="item.groupName+'('+item.groupId+')'">
                        </el-option>
                    </el-select>
                </div>
                <div class="form-item">
                ...
                <div class="form-item">
                    <span></span>
                    <div>
                        <el-button style="margin-right: 10px" type="primary" @click="submit">立即修改</el-button>
...
<script>
    export default {
        ...
        mounted() {
            this.groupVO = this.$route.params.data;
        ...
        methods: {
            ...
            submit() {
                if(this.isGroupVONotNull()) {
                    this.$req._post("/group/update?groupId="+this.groupId,this.groupVO).then(resp => {
                        alert(resp.message);
...
<style scoped>
    ...
    #groupManageEdition  .item-width {
        width: 300px;
    }
    #groupManageEdition  .wrapper {
        margin: 40px;
